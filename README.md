...
│   │   │       └── SymptomRecord.kt    # 症状记录实体
│   │   ├── repository/                 # 数据仓库
│   │   │   ├── MenstrualRepository.kt  # 月经数据仓库
│   │   │   └── SymptomRepository.kt    # 症状数据仓库
│   │   └── preference/                 # 用户偏好设置
...
│   │   ├── list/                       # 记录列表功能
│   │   │   ├── RecordListFragment.kt   # 记录列表页面
│   │   │   └── RecordAdapter.kt        # 记录适配器
│   │   ├── quickadd/                   # 快速添加功能
...
│   │   │   └── BackupRestoreFragment.kt # 备份恢复页面
│   │   └── MainActivity.kt             # 主活动
│   ├── utils/                          # 工具类
│   │   ├── DateUtils.kt                # 日期处理工具
...
└── res/                                # 资源文件
    ...
    │   ├── fragment_record_list.xml    # 记录列表布局
...
- **官方网站**：https://mizhoubaobei.top

## 🔗 相关链接

- [详细文档](https://github.com/xiaomizhoubaobei/womenhealth-app/wiki)
- [常见问题](https://github.com/xiaomizhoubaobei/womenhealth-app/wiki/FAQ)
- [更新日志](https://github.com/xiaomizhoubaobei/womenhealth-app/blob/main/CHANGELOG.md)
- [贡献指南](https://github.com/xiaomizhoubaobei/womenhealth-app/blob/main/CONTRIBUTING.md)
- [行为准则](https://github.com/xiaomizhoubaobei/womenhealth-app/blob/main/CODE_OF_CONDUCT.md)
...
请确保遵循我们的[贡献指南](https://github.com/xiaomizhoubaobei/womenhealth-app/blob/main/CONTRIBUTING.md)和[行为准则](https://github.com/xiaomizhoubaobei/womenhealth-app/blob/main/CODE_OF_CONDUCT.md)。
